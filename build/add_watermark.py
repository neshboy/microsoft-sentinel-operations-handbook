...
if __name__ == "__main__":
    in_path = sys.argv[1] if len(sys.argv) > 1 else r"C:\Users\User\projects\microsoft-sentinel-operations-handbook\_build\Microsoft_Sentinel_Operations.pdf"
    out_path = sys.argv[2] if len(sys.argv) > 2 else r"C:\Users\User\projects\microsoft-sentinel-operations-handbook\_build\Microsoft_Sentinel_Operations_watermarked.pdf"
