...
const REPO_ROOT = "C:/Users/User/projects/microsoft-sentinel-operations-handbook";
...
// This book's initial release ships 18 drafted/reviewed parts only. BOOK-INDEX.md's own
// Appendix Table already lists 3 planned appendix bundles, but appendices/ is empty (no
// appendix has been authored yet) - that's a future edition, not a build defect. Detect
// that up front so the Appendix Table section is skipped entirely instead of emitting
// "MISSING FILE" placeholders for content that was never supposed to exist yet.
...
// and SOC Manager Handbook's index. Parse into the same ordered entry stream build_book expects.
function parseIndex() {
  ...
  for (const raw of lines) {
    ...
    // everything else (prose, "Total: 18 parts.", blank lines, "---") is not TOC-worthy.
  }
  return entries;
}
...
const TAG_COLORS = {
  CONCEPT: "tag-concept",
  ANALYST: "tag-analyst",
  "SENTINEL ENGINEER": "tag-sentinel-engineer",
...
function main() {
  ...
  * { box-sizing: border-box; }
  ...
  .tag-sentinel-engineer { background: var(--blue-tint); color: #164a8a; border: 0.5pt solid var(--blue); }
...
<head>
<meta charset="utf-8">
<title>Microsoft Sentinel Operations</title>
<style>${css}</style>
</head>
<body>
<section class="cover">
  <div class="kicker">NESHBOY SOC Professional Library</div>
  <h1>MICROSOFT SENTINEL OPERATIONS</h1>
  <div class="accent-rule"></div>
  <h2>Workspace Architecture, Analytics Rules, Automation, and Cost Governance — From Query to Platform</h2>
